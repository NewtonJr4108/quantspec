...
* the `tutorial on discrete color sequences < http://127.0.0.1:5000/python/discrete-color/#color-sequences-in-plotly-express>`_
* the `list of built-in continuous color scales < http://127.0.0.1:5000/python/builtin-colorscales/>`_
* the `tutorial on continuous colors < http://127.0.0.1:5000/python/colorscales/>`_
